...
/// Two literals would be two chances for the two banners to read
/// differently. What the browser decides from is the accompanying
/// `DetachCode::TakenOver`, never this text.

...
pub struct Supervisor {
    ...
    uploads: Mutex<HashMap<u64, UploadHandle>>,
...
const UPLOAD_CHUNK_QUEUE: usize =
...
const UPLOAD_SIGNAL_QUEUE: usize = 4;
...
const UPLOAD_PRIORITY_QUEUE: usize = 32;
...
/// session-gone error).
#[derive(Clone)]
struct UploadOutcome(Arc<AtomicU8>);
...
struct UploadRoute {
    ...
    /// will publish.
    signals: mpsc::Sender<UploadSignal>,
...
struct UploadHandle {
    ...
    finished: oneshot::Receiver<std::convert::Infallible>,
}
...
async fn abort_session_uploads(sup: &Arc<Supervisor>, session_id: &str, reason: &str) {
...
fn prune_finished_uploads(routes: &mut HashMap<u32, UploadRoute>) {
...
/// transfer?".
fn commit_without_upload(route: Option<&UploadRoute>, channel: u32) -> (String, ErrorKind) {
    match route {
...
async fn handle_control(
    ...
    match msg {
        ...
        ControlMsg::AbortUpload { channel } => {
...
mod tests {
    ...
    /// [`UploadRoute`]).
    fn no_uploads() -> HashMap<u32, UploadRoute> {
        HashMap::new()
    }

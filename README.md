...
<!-- The image below is a real capture of the web UI against a staged fleet, regenerated by
     ...
     the URL between the markers. See docs/readme-hero/SPEC.md. Do not edit the URL by hand. -->

![Farhelm supervising seven agent sessions across three hosts, with one session's Claude Code terminal
open](<!-- readme-hero-url -->https://raw.githubusercontent.com/scode/farhelm/9eb69b37fd9dd7dea97871f664b90d7be872b4e2/readme-hero.png<!-- /readme-hero-url -->)

...
agents already running. Any value other than `on` or `off` is a typo rather than an instruction: the supervisor warns,
names what you wrote, and behaves as if the variable were unset.

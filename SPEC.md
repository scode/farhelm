...
completed-step count, and client-measured elapsed time inline in the status spot. Reduced-motion settings replace the
...
— falls back to the manual path (run the binary yourself), which always remains available.
